...
const GptImageEdit = () => {
  ...
  const targetImage: any = useRef<HTMLInputElement>(null);
  const maskImage: any = useRef<HTMLInputElement>(null);
  ...
  const generateImage = async () => {
    ...
    const target = "https://placeimg.com/512/512/people";
    const mask = maskImage.current.value;
    ...
    <div>
      <div className="grid grid-cols-2 gap-10">
        <div className="flex justify-start items-center">
          <span className="min-w-[120px] text-xs">Target Image</span>
          <input
            ref={targetImage}
            className="block w-full  text-xs text-gray-900 border border-gray-300  cursor-pointer bg-white focus:outline-none"
            type="file"
          />
        </div>

        <div className="flex justify-start items-center">
          <span className="min-w-[120px] text-xs">Mask Image</span>
          <input
            ref={maskImage}
            className="block w-full  text-xs text-gray-900 border border-gray-300  cursor-pointer bg-white focus:outline-none"
            type="file"
